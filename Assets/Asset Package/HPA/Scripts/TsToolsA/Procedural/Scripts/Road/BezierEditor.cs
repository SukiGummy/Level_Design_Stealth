                ...
                if (i % 3 == 0)
                {
...
#else
                        var fmh_249_78_639230228040328918 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap);
#endif
...
#else
                        var fmh_265_78_639230228040331438 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap);
#endif
                    ...
                    else
                    {
                        ...
                        else if (showGizmo || !showGizmo && isShowTangent)
                        {
                            ...
                            newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap); 
#else
                                var fmh_290_86_639230228040333856 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .3f, Vector3.zero, Handles.SphereHandleCap);
#endif
                            ...
                            newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap); 
#else
                                var fmh_299_86_639230228040335997 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .2f, Vector3.zero, Handles.SphereHandleCap);
#endif
...
#else
                            var fmh_335_82_639230228040338428 = Quaternion.identity; newTargetPosition = Handles.FreeMoveHandle(pointPos, size * .1f, Vector3.zero, Handles.SphereHandleCap);
#endif
