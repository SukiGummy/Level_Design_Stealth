...
namespace DiasGames.Editors
{
    ...
    {
        [MenuItem("Tools/Dias Games/Setup Project Settings")]
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Set Layers & Tags", button))
            {
                UpdateLayers();
            }
        ...
        void UpdateLayers()
        {
            ...
            AddNewLayer(layersProperty, 17, "Wall Run");

            AddNewTag(tagsProperty, "Ledge");
            AddNewTag(tagsProperty, "LedgeLimit");
            AddNewTag(tagsProperty, "Vault");
            AddNewTag(tagsProperty, "Mantle");
            AddNewTag(tagsProperty, "Ladder");
            AddNewTag(tagsProperty, "Teeter");
            AddNewTag(tagsProperty, "JumpDestination");
            AddNewTag(tagsProperty, "MovableGround");
